...
function AlterEgo:CreateWindow(name, title, parent)
    ...
    do -- Titlebar
        ...
        windowFrame.TitleBar.Icon:SetTexture(self.constants.assets.textures.logo)
        ...
        windowFrame.TitleBar.Text:SetFont(self.constants.assets.font.file, self.constants.assets.font.size + 2, self.constants.assets.font.flags)
        ...
        windowFrame.TitleBar.CloseButton.Icon:SetTexture(self.constants.assets.textures.iconClose)
