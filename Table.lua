  ...
  function frame:RenderTable()
    ...
    addon.Utils:TableForEach(frame.data.rows, function(row, rowIndex)
      ...
      addon.Utils:TableForEach(row.columns, function(column, columnIndex)
        ...
        columnFrame.text:SetPoint("TOPLEFT", columnFrame, "TOPLEFT", columnConfig.padding and columnConfig.padding or frame.config.cells.padding, columnConfig.padding and -columnConfig.padding or -frame.config.cells.padding)
        columnFrame.text:SetPoint("BOTTOMRIGHT", columnFrame, "BOTTOMRIGHT", columnConfig.padding and -columnConfig.padding or -frame.config.cells.padding, columnConfig.padding and columnConfig.padding or frame.config.cells.padding)
