...
function UI:SetupButtons()
  ...
  self.window.titlebar.RunHistoryButton = CreateFrame("Button", "$parentRunHistoryButton", self.window.titlebar)
  local runHistoryButton = self.window.titlebar.RunHistoryButton
  runHistoryButton:SetPoint("RIGHT", vaultButton, "LEFT", 0, 0)
  ...
  runHistoryButton:SetScript("OnEnter", function()
    ...
    addon.Utils:SetBackgroundColor(runHistoryButton, 1, 1, 1, 0.05)
    GameTooltip:SetOwner(runHistoryButton, "ANCHOR_TOP")
    GameTooltip:SetText("Run History", 1, 1, 1, 1, true)
    GameTooltip:AddLine("Open it!", nil, nil, nil, true)
    GameTooltip:Show()
  end)
  runHistoryButton:SetScript("OnLeave", function()
    runHistoryButton.Icon:SetVertexColor(0.7, 0.7, 0.7, 1)
    addon.Utils:SetBackgroundColor(runHistoryButton, 1, 1, 1, 0)
    GameTooltip:Hide()
  end)
  runHistoryButton.Icon = self.window.titlebar:CreateTexture("$parentIcon", "ARTWORK")
  runHistoryButton.Icon:SetPoint("CENTER", runHistoryButton, "CENTER")
  runHistoryButton.Icon:SetSize(13, 13)
  runHistoryButton.Icon:SetTexture(addon.Constants.media.IconCharacters)
  runHistoryButton.Icon:SetVertexColor(0.7, 0.7, 0.7, 1)
end
