...
- Added a raid kill icon option (skull or diamond) under Raids in the options.
...
- Added a new keybind for opening the equipment window.
- Added a new minimap shortcut for opening the equipment window.
